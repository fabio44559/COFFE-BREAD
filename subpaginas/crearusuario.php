...
<br><br>
<center><h2>Agregar usuario</h2></center><br><hr>
<form method="POST" enctype="multipart/form-data">
	...
	<table width="1000" height ="350" align="center">
        ...
        <tr>
            <td><center><label>Contrase̱a: </label><input type="text"  name="clave" maxlength="64"></center></td> 
        </tr>				 
        <tr>
            <th colspan="2">
            <center><br>
            <input type="submit" name="enviar" value="Agregar Usuario">
            </th>
		</tr>
</table>    
...
<form method="POST">
	<input type="submit"  name="vmproductos" value="Volver a la administracion de usuarios"><br>
</form>		
...
{
	header("location:menuusuarios.php?usuario=$idusuario");
}
